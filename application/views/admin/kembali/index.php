        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <!-- <div class="m-b-30">
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url('admin/kembali/add');?>"><button type="button" class="btn btn-outline-info waves-light waves-effect w-md">Add +</button></a>
                    </div> -->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/kembali/add/'.$data['id_dn']); ?>"><i class="mdi mdi-backup-restore"></i></a> &nbsp;
