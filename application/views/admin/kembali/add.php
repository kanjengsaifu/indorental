...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            ...
            <br/>
            <div class="p-20">
              <form method="post" action="<?php echo base_url();?>admin/kembali/addto" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <button type="submit" name="submit" class="btn btn-primary btn-sm">Add</button> &nbsp; <?php echo anchor('admin/kembali/done','Next',array('class'=>'btn btn-success btn-sm'))?>
                        </div>
                    </div>
            </div>
                </form>
