                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                       ...
                       <?php $no=1; foreach($barang as $b){ ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/barang/edit/'.$b['id_barang']); ?>"><i class="dripicons-document-edit"></i></a> &nbsp;
                                <a href="<?php echo site_url('admin/barang/remove/'.$b['id_barang']); ?>"><i class="dripicons-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('admin/barang/simpan'); ?>
