        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <h6 class="text-muted text-uppercase mb-3">Barang</h6>
                    <h4 class="mb-3" data-plugin="counterup">
                        <?php foreach ($barang as $a => $data) { ?>
            ...
            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <h6 class="text-muted text-uppercase mb-3">Pinjam</h6>
            ...
            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card-box tilebox-one">
                    ...
                    <h6 class="text-muted text-uppercase mb-3">Kembali</h6>
                    ...
                    <div class="inbox-widget slimscroll" style="max-height: 370px;">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-1.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-2.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-3.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-4.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-5.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-6.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-8.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="<?php echo base_url();?>assets/assets/images/users/avatar-9.jpg" class="rounded-circle bx-shadow-lg" alt=""></div>
