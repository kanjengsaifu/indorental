...
<html>
    <head>
        ...
        <link href="<?php echo base_url('assets/assets/css/dataTables.bootstrap.min.css')?>" rel="stylesheet">

        <script src="<?php echo base_url();?>assets/assets/js/modernizr.min.js"></script>
        
        <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/assets/js/dropify.min.css'?>">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('admin/barang');?>"><i class="mdi mdi-laptop-mac "></i> <span> Barang </span> </span></a>
                            </li>

                            <li>
                                <a href="<?php echo base_url('admin/konsumen');?>"><i class="mdi mdi-account-network"></i> <span> Konsumen </span> </span></a>
                            </li>

                            <li>
                                <a href="#"><i class="mdi mdi-airplane-takeoff"></i> <span> Pinjam </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="<?php echo base_url('admin/invoice');?>">Invoice</a></li>
                                    <li><a href="<?php echo base_url('admin/dn');?>">DN</a></li>
                                    <li><a href="<?php echo base_url('admin/detail_dn');?>">Detail DN</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="<?php echo base_url('admin/kembali');?>"><i class="mdi mdi-airplane-landing "></i> <span> Kembali</a>
                            </li>

                            <li>
                                <a href="#"><i class="fi-briefcase"></i> <span> Setting </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="<?php echo base_url('admin/kategori');?>">Kategori</a></li>
                                    <li><a href="<?php echo base_url('admin/spek');?>">Spesifikasi</a></li>
                                    <li><a href="<?php echo base_url('admin/company');?>">Company</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="<?php echo base_url('admin/user');?>"><i class="mdi mdi-account-key "></i> <span> User </span> </a>
                            </li>
                        </ul>
