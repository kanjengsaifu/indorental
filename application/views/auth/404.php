                                    ...
                                    <div class="account-logo-box">
                                        <h2 class="text-uppercase text-center">
                                            <a href="index.html" class="text-success">
                                                <!-- <span><img src="<?php echo base_url();?>assets/assets/images/logo_dark.png" alt="" height="18"></span> -->
                                            </a>
                                        </h2>
                                    </div>
                                    <div class="account-content text-center">
                                        <h1 class="text-error">404</h1>
                                        <h4 class="text-uppercase text-danger mt-3">Halaman Tidak Tersedia</h4>
                                        <p class="text-muted mt-3">Silahkan hubungi Administrator untuk membuat username dan password, agar dapat mengakses website.</p>

                                        <a class="btn btn-md btn-block btn-gradient waves-effect waves-light mt-3" href="<?php echo base_url();?>auth"> Kembali Login</a>
                                    </div>
                                </div>
                            </div>
                            <!-- end card-box-->
