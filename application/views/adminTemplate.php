                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url('barang');?>"><i class="mdi mdi-laptop-mac "></i> <span> Barang </span> </span></a>
                            </li>

                            <li>
                                <a href="<?php echo base_url('konsumen');?>"><i class="mdi mdi-account-network"></i> <span> Konsumen </span> </span></a>
                            </li>

                            <li>
                                <a href="<?php echo base_url('transaksi');?>"><i class="mdi mdi-arrow-collapse-all"></i> <span> Transaksi </span> </a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="<?php echo base_url('spek');?>"">Spesifikasi</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="<?php echo base_url('user');?>"><i class="mdi mdi-account-key "></i> <span> User </span> </a>
                            </li>
                        </ul>
