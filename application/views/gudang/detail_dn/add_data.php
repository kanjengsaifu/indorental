...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            ...
            <br/>
            <div class="p-20">
              <form method="post" action="<?php echo base_url();?>gudang/detail_dn/done" method="post" accept-charset="utf-8">
