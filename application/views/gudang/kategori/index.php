                ...
                <div class="card-box table-responsive">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                       ...
                       <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('gudang/kategori/edit/'.$i['id_kategori']); ?>"><i class="dripicons-document-edit"></i></a> | 
                                <a href="<?php echo site_url('gudang/kategori/remove/'.$i['id_kategori']); ?>"><i class="dripicons-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       ...
                       <?php echo form_open('gudang/kategori/add'); ?>
